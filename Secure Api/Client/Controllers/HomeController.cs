...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        private string getTurnoutUrl(string stateId)
        {
            string url = "https://localhost:44310/turnout";
            if (stateId != "ALL")
            {
                url = url + "/" + stateId;
            }
        ...
        [Authorize]
        public async Task<IActionResult> Secret(string state_id)
        {
            var turnoutApiUrl = getTurnoutUrl(state_id);
            ...
            var apiResponse = await AccessTokenRefreshWrapper(
                () => SecuredGetRequest(turnoutApiUrl));

            var apiResponseContent = await apiResponse.Content.ReadAsStringAsync();
            var content = apiResponseContent;

            return View(model: apiResponseContent);
        }
        ...
        private async Task RefreshAccessToken()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:44388/oauth/token")
            {
